...
public class CreateProductwithMandatoryField {
	...
	public static void main(String[] args) throws IOException  {
		...
		else
		{
			...
			FileInputStream fis2=new FileInputStream("./src\\test\\resources\\E4235.xlsx");
		...
		Boolean toastdis = wait.until(ExpectedConditions.invisibilityOf(alert));
		...
		//String pid = "1"+(100+ r.nextInt(100));
		
		Sheet sh2 = wb.getSheet("Product");

		String productname = sh2.getRow(1).getCell(0).getStringCellValue();
		String quantity = sh2.getRow(1).getCell(1).getStringCellValue();
		String ppu = sh2.getRow(1).getCell(2).getStringCellValue();
		String category = sh2.getRow(1).getCell(3).getStringCellValue();
		String vendor = sh2.getRow(1).getCell(4).getStringCellValue();
		...
		WebElement alert1 = wait1111.until(
		        ExpectedConditions.visibilityOfElementLocated(
		                By.xpath("//div[@role='alert']")
		        ));
	
		WebDriverWait wait11111=new WebDriverWait(driver, Duration.ofSeconds(10));
		wait11111.until(ExpectedConditions.visibilityOf(alert1));
		String msg1=alert1.getText();
		
		
		if(msg1.contains(productname))
		{
